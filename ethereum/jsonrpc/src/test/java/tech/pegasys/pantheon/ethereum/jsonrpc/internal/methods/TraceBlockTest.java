...
public class TraceBlockTest {
  ...
  private final TraceBlock traceBlock =
      new TraceBlock(parameters, blockTracer, new MainnetBlockHeaderFunctions(), blockchainQueries);
  ...
  public void shouldReturnCorrectResponse() {
    ...
    final JsonRpcSuccessResponse response = (JsonRpcSuccessResponse) traceBlock.response(request);
