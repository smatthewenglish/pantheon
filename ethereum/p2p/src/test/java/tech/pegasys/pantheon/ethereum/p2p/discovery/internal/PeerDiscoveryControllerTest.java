...
public class PeerDiscoveryControllerTest {
    ...
    private void neighborsPacketGenerator(List<DiscoveryPeer> peers) {
        for (int i = 0; i <= 15; i++) {
            final Packet neighborsPacket = MockPacketDataFactory.mockNeighborsPacket(peers.get(i), peers.get(16));
    ...
    private void pongPacketGenerator(List<DiscoveryPeer> peers, Packet pingPacket) {
        for (int i = 0; i <= 14; i++) {
            final Packet pongPacket = MockPacketDataFactory.mockPongPacket(peers.get(i), pingPacket.getHash());
