...
public class RecursivePeerRefreshStateTest {
  ...
  // TODO: These should probably not be mocks...
  // private final RecursivePeerRefreshState.BondingAgent bondingAgent =
  // PeerDiscoveryController::bond;
  ...
  public void setup() throws Exception {
    ...
    // TODO: Recreate w/o mocks
    //        recursivePeerRefreshState =
    //                new RecursivePeerRefreshState(
    //                        new PeerBlacklist(),
    //                        new
    // NodeWhitelistController(PermissioningConfiguration.createDefault()),
    //                        bondingAgent,
    //                        neighborFinder,
    //                        30);
  ...
  public void shouldIssueRequestToPeerWithLesserDistanceGreaterHops() {
    // recursivePeerRefreshState.start(Collections.singletonList(peer_000), target);

    // verify(bondingAgent).performBonding(peer_000, false);

    // assertThat(peer_000.getStatus()).isEqualTo(PeerDiscoveryStatus.BONDING);
    ...
    //
    //        recursivePeerRefreshState.onNeighboursPacketReceived(peer_000,
    ...
    //
    //        assertThat(peer_010.getStatus()).isEqualTo(PeerDiscoveryStatus.BONDING);
    //        assertThat(peer_011.getStatus()).isEqualTo(PeerDiscoveryStatus.BONDING);
    //        assertThat(peer_012.getStatus()).isEqualTo(PeerDiscoveryStatus.BONDING);
    //        assertThat(peer_013.getStatus()).isEqualTo(PeerDiscoveryStatus.BONDING);
    //
    ...
    //        recursivePeerRefreshState.onBondingComplete(peer_011);
    //
    //        peer_012.setStatus(PeerDiscoveryStatus.BONDED);
    //        recursivePeerRefreshState.onBondingComplete(peer_012);
    //
    //        peer_013.setStatus(PeerDiscoveryStatus.BONDED);
    //        recursivePeerRefreshState.onBondingComplete(peer_013);
    //
    ...
    //        recursivePeerRefreshState.onNeighboursPacketReceived(neighborsPacketData_011,
    // peer_011);
    //
    //
    ...
    //
    //        recursivePeerRefreshState.onNeighboursPacketReceived(neighborsPacketData_012,
    // peer_012);
    //
    //
    // assertThat(recursivePeerRefreshState.getOutstandingRequestList().size()).isLessThanOrEqualTo(3);
    ...
    //
    //        recursivePeerRefreshState.onNeighboursPacketReceived(neighborsPacketData_013,
    // peer_013);
    //
    //
    // assertThat(recursivePeerRefreshState.getOutstandingRequestList().size()).isLessThanOrEqualTo(3);
  ...
  public void shouldIssueRequestToPeerWithGreaterDistanceOnExpirationOfLowerDistancePeerRequest() {
    ...
    //
    //        recursivePeerRefreshState.onNeighboursPacketReceived(neighborsPacketData_000,
    // peer_000);
    //
    //
    // assertThat(recursivePeerRefreshState.getOutstandingRequestList().size()).isLessThanOrEqualTo(3);
