...
public class PeerDiscoveryBootstrappingTest extends AbstractPeerDiscoveryTest {
    ...
    public void deconstructedIncrementaly() throws Exception {
        ...
        await().atMost(5, TimeUnit.SECONDS).untilAsserted(() -> assertThat(peerDiscoveryAgent_0.getPeers()).hasSize(0));
        ...
        await().atMost(5, TimeUnit.SECONDS).untilAsserted(() -> assertThat(peerDiscoveryAgent_0.getPeers()).hasSize(1));
        await().atMost(5, TimeUnit.SECONDS).untilAsserted(() -> assertThat(peerDiscoveryAgent_1.getPeers()).hasSize(1));
        ...
        await().atMost(5, TimeUnit.SECONDS).untilAsserted(() -> assertThat(peerDiscoveryAgent_TEST.getPeers()).hasSize(2));
